...
# plt.tight_layout()
plt.savefig('trials.svg',dpi=800)
...
temp0 = [i[i.Trial==3].Result.values[0] for i in participants]
temp1 = [i[i.Trial==3].Result.values[1] for i in participants]
temp2 = [i[i.Trial==3].Result.values[2] for i in participants]
ci0 = bootstrap_mean(temp0)
ci1 = bootstrap_mean(temp1)
ci2 = bootstrap_mean(temp2)

lo = [turk[2][0]-ci1[0], turk[2][1]-ci0[0], turk[2][2]-ci2[0]]
hi = [ci1[1]-turk[2][0], ci0[1]-turk[2][1], ci2[1]-turk[2][2]]
ax.grid(linestyle='-',linewidth=.20,color='gray')

sns.barplot(range(3),turk[2],ax=ax, yerr=(lo,hi),ecolor='black',error_kw=dict(elinewidth=2,capsize=10,capthick=2),edgecolor='black',linewidth=1)
ax.set_title('Participants',fontsize=16)
plt.ylim([-1.5,1.5])
plt.xticks(x,fullNames[2],rotation=-20,horizontalalignment='center',fontsize=15)
...
sns.barplot(range(3),full[2],ax=ax,edgecolor='black',linewidth=1)
...
sns.barplot(range(3),lesion[2],ax=ax,edgecolor='black',linewidth=1)
...
fig5.text(0.06,0.7,'Judgment',rotation='90',fontsize=17)
fig5.text(0.5,.06,'Hypothesis',fontsize=17)

plt.savefig('fig5.svg',dpi=800)
...
fig6.text(0.06,0.7,'Judgment',rotation='90',fontsize=17)
fig6.text(0.5,.06,'Hypothesis',fontsize=17)

plt.savefig('fig6.svg',dpi=800)
...
# lo = [turk[17][0]-ci2[0], turk[17][1]-ci1[0], turk[17][2]-ci0[0]]
# hi = [ci2[1]-turk[17][0], ci1[1]-turk[17][1], ci0[1]-turk[17][2]]
# sns.barplot(range(3),turk[17],ax=ax, yerr=(lo,hi),ecolor='black',error_kw=dict(elinewidth=2,capsize=10,capthick=2),edgecolor='black',linewidth=1)
# ax.set_title('Participants')
# plt.ylim([-1.5,1.5])
# plt.xticks(x,fullNames[17],rotation=-20,horizontalalignment='center',fontsize=12)
# # plt.errorbar(range(3),yerr=[[-1,-1,-1],[1,1,1]])
...
# # plt.margins(.2)
# # ax.set_title('Full Model')
# sns.barplot(range(3),full[17],ax=ax,edgecolor='black',linewidth=1)
# plt.ylim([-1.5,1.5])
...
# # plt.ylim([-1.5,1.5])
# # ax.set_title('Prior only')
# sns.barplot(range(3),lesion[17],ax=ax,edgecolor='black',linewidth=1)
